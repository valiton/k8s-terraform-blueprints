...
variable "os_private_network_cidr" {
  description = "Private network CIDR, if empty a random CIDR will be chosen"
  type        = string
  default     = ""
}
...
variable "custom_ca_cert" {
  description = "Custom CA certificate in PEM format"
  default     = ""
}

variable "client_cert" {
  description = "client certificate in PEM format signed by custom CA"
  default     = ""
}
